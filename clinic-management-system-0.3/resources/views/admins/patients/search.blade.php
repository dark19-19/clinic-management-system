                ...
                <table>
                    ...
                    @if(isset($patient))
                        <tr>
                            ...
                            <td>{{$patient->insurance_info}}</td>
                            <td>{{$patient->blood_group}}</td>
                            <td>{{$patient->medical_history}}</td>
                            <td class="quick-actions flex flex-row">
                                <a href="{{route('patient.edit',$patient->id)}}" style="fill: var(--success); color: var(--success); font-size: 18px">
                                ...
                                <a href="#" style="fill: var(--danger); color: var(--danger); font-size: 12px" onclick="event.preventDefault(); document.getElementById('delete-form-{{$patient->id}}').submit();">
                                    @method('delete')
