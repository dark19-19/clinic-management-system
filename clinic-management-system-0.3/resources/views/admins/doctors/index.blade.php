                ...
                @if(isset($doctors))
                    @foreach($doctors as $doctor)
                        <tr>
                            ...
                            <td>{{$doctor->call_hours}}</td>
                            <td>{{$doctor->available_hours}}</td>
                            <td class="quick-actions flex flex-row" style="gap: 20px">
                                <a href="{{route('doctor.edit', $doctor->id)}}"
                                   style="fill: var(--success); color: var(--success); font-size: 18px">
                                ...
                                <a href="{{"delete"}}"
                                   style="fill: var(--danger); color: var(--danger); font-size: 12px"
                                ...
                                <a href="{{route('doctor.patient.appointments', $doctor->id)}}"
                                   style="fill: var(--main-color); color: var(--main-color); font-size: 6px">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                        <path
                                ...
                                <a href="{{route('doctor.user.appointments', $doctor->id)}}" style="fill: var(--main-color); color: var(--main-color); font-size: 6px">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                        <path
                                ...
                                <form id="delete-form-{{$doctor->id}}" action="{{route('doctor.delete',$doctor->id)}}"
