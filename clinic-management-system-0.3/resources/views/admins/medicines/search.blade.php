@extends('layouts.app')
@section('title','Search Medicine')
@section('page.title','Search For Medicine')
@section('content')
    <div class="card" style="height: 70vh">
        ...
        <div class="content">
            <form action="{{route('medicine.search')}}" method="GET" class="search-form">
                @csrf
                @method('get')
                        ...
                        <tr>
                            ...
                            <td class="quick-actions flex flex-row">
                                ...
                                <a href="{{"delete"}}"
                                   ...
                                   onclick="event.preventDefault(); document.getElementById('delete-form-{{$medicine->id}}').submit();">
